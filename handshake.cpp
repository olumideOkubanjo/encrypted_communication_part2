...
enum clientState {
  ...
  START, WAITINGFORACK, DATAEXCHANGE
};
enum serverState {
  // **** you will have add more state names here!
  LISTEN, WAITINGFORKEY, WAIRFORACK, DATAEXCHANGE
};
...
int main(){
    ...
    //Handshaking Code
    while((clientState!=DATAEXCHANGE) && (serverState!=DATAEXCHANGE)){
        if(serverStatebool){
